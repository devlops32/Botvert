...
class Database:
    ...
    def add_user(self, user_id: int, username: str = None, first_name: str = None, last_name: str = None, 
        ...
        """Добавление или обновление пользователя с полной информацией"""
        try:
            ...
            if exists:
                ...
                self.cursor.execute('''
                    INSERT INTO users (user_id, username, first_name, last_name, full_name, language_code, is_bot, is_admin, created_at, last_activity)
    ...
    def get_all_users_info(self) -> List[Dict]:
        ...
        self.cursor.execute('''
            SELECT user_id, username, first_name, last_name, full_name, 
                   language_code, is_admin, created_at, last_activity 
            FROM users 
    ...
    def get_user_stats(self) -> Dict:
        ...
        ''')
        week_active = self.cursor.fetchone()[0]
    ...
    def create_order(self, user_id: int, product_id: int, city_id: int, product_name: str, 
        ...
        try:
            ...
            self.log_user_activity(user_id, "create_order", f"Order created: {product_name} - {quantity}")
    ...
    def get_order_by_id(self, order_id: int):
        """Получить заказ по ID с информацией о пользователе"""
        self.cursor.execute('''
            SELECT o.*, u.user_id, u.username, u.first_name, u.last_name 
            FROM orders o
