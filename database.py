...
class Database:
    ...
    # ============ МЕТОДЫ ДЛЯ РАБОТЫ С ТОВАРАМИ (РАСШИРЕННЫЕ) ============
    ...
    def get_products_by_city(self, city_id: int, show_all: bool = False) -> List[Dict]:
        """Получить товары по городу. Если show_all=True, показывает все товары (включая недоступные)"""
        query = '''
    ...
    def get_all_products(self) -> List[Dict]:
        """Получить все товары с информацией о городе"""
        self.cursor.execute('''
